...
class InfoShipDelivering extends StatefulWidget {
  late List<dynamic> lstWayBills;
  InfoShipDelivering(this.lstWayBills);

  @override
  State<InfoShipDelivering> createState() => _InfoShipDeliveringState();
}

class _InfoShipDeliveringState extends State<InfoShipDelivering> {
  @override
