...
class OrderReturnedState extends State<OrderReturned> {  
  ...
  Widget build(BuildContext context) {
    ...
    List<OrderInfo> lstOrderReturned = [];
    for( var order in lstOrder) {
        if((order.orderStatus == "COMPLETED" ) && order.type == "RETURN_ORDER" ){
          lstOrderReturned.add(order);
        }
    }  
      ...
      //có đơn
          ? Container(
             child: Column( children: [
                ...
                ListView.builder(
                   reverse: true,
                   itemCount:lstOrderReturned.length,              
                   shrinkWrap: true,
                   ...
                   itemBuilder: (BuildContext context, int index) {
                     ...
                     return Column(
                       children: [   
                         ...
                         GestureDetector(
                           onTap: (){
                             Navigator.push(context, MaterialPageRoute(builder: (context) => DetailConfirm(lstOrderReturned[index])));
                           },
                           child: Container(
                             width: 100.w,
                             height: 245,
                                   ...
                                   child: Row(
                                     children: [
                                        ...
                                        SizedBox(
                                          width: myWidth*0.6,
                                          child:  Text(
                                            "Đơn hàng #" + "${lstOrderReturned[index].orderCode}",
                                            style: TextStyle(
                                              color: textColor,
                                              fontSize: 16,
                                        ...
                                        SizedBox(
                                          width: myWidth*0.3,
                                          child: Text(
                                            "${convertTime(lstOrderReturned[index].createTime)}",
                                            style: TextStyle(
                                              color: textColor,
                                              fontSize: 12,
                                 ...
                                 SizedBox(
                                   ...
                                   child: Row(children: [
                                      ...
                                      SizedBox(
                                        ...
                                        width: myWidth*0.3,
                                        child: Image.network(
                                          getUrlFromLinkImg("${lstOrderReturned[index].orderDetails[0]['unit']['product']['linkImg']}")
                                        ),
                                      ),
                                      SizedBox(width: 10,),
                                  //Tên, đơn vị + số lượng
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          width: myWidth*0.5,
                                          child: Text(
                                            "${lstOrderReturned[index].orderDetails[0]['unit']['product']['name']}", 
                                             maxLines: 1,
                                        ...
                                        SizedBox(
                                          ...
                                          width: myWidth*0.5,
                                          child: Text(
                                             "Đơn vị: " + "${lstOrderReturned[index].orderDetails[0]['unit']['name']}", 
                                             maxLines: 1,
                                             overflow: TextOverflow.ellipsis,
                                             softWrap: false,
                                             textAlign: TextAlign.left,
                                        ...
                                        SizedBox(
                                          ...
                                          width: myWidth*0.5,
                                          child: Text(
                                             "Số lượng: " + "${lstOrderReturned[index].orderDetails[0]['quantity']}", 
                                             maxLines: 1,
                                             overflow: TextOverflow.ellipsis,
                                             softWrap: false,
                                             textAlign: TextAlign.left,
                                       ...
                                       SizedBox(
                                         ...
                                         child: Row(
                                           children: [
                                             ...
                                             SizedBox(width: 2,),
                                             Text("${lstOrderReturned[index].orderDetails.length} sản phẩm", style: TextStyle(color: Color(0xff7b2626)),)
                                           ],
                                         ),
                                       ),
                                         ...
                                         child: Row(
                                           children: [
                                             ...
                                             SizedBox(
                                               width: myWidth*0.22,
                                               child: Text(
                                                 "${lstOrderReturned[index].totalPayment.replaceAllMapped(reg, mathFunc)}", 
                                          ...
                                          DialogButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              await showDialog (
                                                  context: context,
                                                  builder: (context) =>
                                                    FutureProgressDialog(deleteThisOrder(lstOrderReturned[index].id), message: Text('Đang xóa...', style: TextStyle(color:Color(0xffe2dddd)))),
                                              ); */
                                              //ẩn pop-up
