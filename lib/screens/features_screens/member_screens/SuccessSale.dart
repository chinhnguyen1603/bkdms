        ...
        body: Container(
         ...
         child: Column(
            children: [
              ...
              SizedBox(
                width: 80.w,
                child: Text("Thông tin đơn hàng đã được gửi và chờ xác nhận từ hệ thống", textAlign: TextAlign.center ,maxLines: 2, style: TextStyle(fontSize: 14, color: textColor, fontWeight: FontWeight.w400),)
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                     ...
                     Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => HomePage(1)), (Route<dynamic> route) => false);
                  },
                  style: ButtonStyle(
