                       ...
                       child: Container(
                           ...
                           child: Column(
                             children: <Widget>[
                               ...
                               SizedBox(width: 100.w, height: 3,),
                               SizedBox(width: myWidth, child: Text("• Có 3 phương thức bao gồm trả tiền mặt, chuyển khoản ngân hàng và thanh toán qua ví điện tử Momo. Hạn thanh toán được quy định cụ thể cho từng đại lý và hiển thị trong mục công nợ, bắt đầu tính từ khi đại lý có nợ lớn hơn 0."),),
                               SizedBox(width: 100.w, height: 3,),
